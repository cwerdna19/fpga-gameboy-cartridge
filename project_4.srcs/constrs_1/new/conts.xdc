...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { data[0] }]; #IO_L4P_T0_D04_14 Sch=ja_p[1]
#set_property -dict { PACKAGE_PIN L18   IOSTANDARD LVCMOS33 } [get_ports { data[1] }]; #IO_L4N_T0_D05_14 Sch=ja_n[1]
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { data[2] }]; #IO_L5P_T0_D06_14 Sch=ja_p[2]
#set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { data[3] }]; #IO_L5N_T0_D07_14 Sch=ja_n[2]
#set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { data[4] }]; #IO_L7P_T1_D09_14 Sch=ja_p[3]
#set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { data[5] }]; #IO_L7N_T1_D10_14 Sch=ja_n[3]
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { data[6] }]; #IO_L8P_T1_D11_14 Sch=ja_p[4]
#set_property -dict { PACKAGE_PIN N18   IOSTANDARD LVCMOS33 } [get_ports { data[7] }]; #IO_L8N_T1_D12_14 Sch=ja_n[4]

## Pmod Header JB
set_property -dict {PACKAGE_PIN P17 IOSTANDARD LVCMOS33} [get_ports nWR]
set_property -dict {PACKAGE_PIN P18 IOSTANDARD LVCMOS33} [get_ports nRD]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports nCS]
set_property -dict {PACKAGE_PIN T18 IOSTANDARD LVCMOS33} [get_ports OE]
...
## Pmod Header JC
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports {data[0]}]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports {data[1]}]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports {data[2]}]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33} [get_ports {data[3]}]
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports {data[4]}]
set_property -dict {PACKAGE_PIN P13 IOSTANDARD LVCMOS33} [get_ports {data[5]}]
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports {data[6]}]
...
set_property -dict {PACKAGE_PIN L13 IOSTANDARD LVCMOS33} [get_ports {address[0]}]
set_property -dict {PACKAGE_PIN N13 IOSTANDARD LVCMOS33} [get_ports {address[1]}]
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS33} [get_ports {address[2]}]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {address[3]}]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports {address[4]}]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports {address[5]}]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports {address[6]}]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports {address[7]}]
set_property -dict {PACKAGE_PIN R15 IOSTANDARD LVCMOS33} [get_ports {address[8]}]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports {address[9]}]
...
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports {address[10]}]
set_property -dict {PACKAGE_PIN H17 IOSTANDARD LVCMOS33} [get_ports {address[11]}]
set_property -dict {PACKAGE_PIN K14 IOSTANDARD LVCMOS33} [get_ports {address[12]}]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {address[13]}]
...
set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports {address[14]}]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports {address[15]}]
...
set_property MARK_DEBUG true [get_nets {address_IBUF[0]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[2]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[4]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[10]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[14]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[1]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[8]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[11]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[15]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[3]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[5]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[6]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[7]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[13]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[9]}]
set_property MARK_DEBUG true [get_nets {address_IBUF[12]}]
...
connect_debug_port u_ila_0/probe1 [get_nets [list {address_IBUF[0]} {address_IBUF[1]} {address_IBUF[2]} {address_IBUF[3]} {address_IBUF[4]} {address_IBUF[5]} {address_IBUF[6]} {address_IBUF[7]} {address_IBUF[8]} {address_IBUF[9]} {address_IBUF[10]} {address_IBUF[11]} {address_IBUF[12]} {address_IBUF[13]} {address_IBUF[14]} {address_IBUF[15]}]]
